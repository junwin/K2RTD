//-----------------------------------------------------------------------
// <copyright file="StreamHelper.cs" company="KaiTrade LLC">
...
{
	/// <summary>
	/// Summary description for StreamHelper.
	/// </summary>
	public class StreamHelper
	{
        ...
        static public void WriteMsg(out string myData, KaiMessageWrap myKaiMsg)
        {
            myData = strTok;
